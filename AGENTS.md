...
src/
  ...
  components/
    ...
    monitors/
      ...
      layouts/                   # SpotlightLayout, BoardLayout, TableLayout, ImageTableLayout, CountersLayout, CounterCard, TicketTableRow, elementos compartidos
```
